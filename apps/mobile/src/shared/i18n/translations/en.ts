export const en = {
  ...
  announcement: {
    ...
    subtitle: "Notify every user",
    audience: "Goes to {recipients} users · {push} get an instant push",
    audienceLoading: "Counting recipients...",
    audienceUnavailable: "Couldn't count recipients",
    hint: "Use this only for outages users will notice. Frequent notifications get switched off, and then the important one is missed.",
    useMaintenanceTemplate: "Maintenance template",
    titleLabel: "Title",
    titlePlaceholder: "e.g. Planned maintenance",
    messageLabel: "Message",
    messagePlaceholder: "The text users will see",
    placeholderLeft: "Fill in the bracketed fields from the template.",
    preview: "How it will look on the phone",
    previewNow: "now",
    send: "Send",
    confirmTitle: "Send this announcement?",
    confirmBody: "This notification goes to {count} users across every company and can't be taken back.",
    confirmSend: "Send to Everyone",
    sentTitle: "Announcement sent",
    sentBody: "Delivering to {count} users.",
    duplicate: "This announcement was sent a few minutes ago. Wait a little before sending the same text again.",
    sendError: "The announcement couldn't be sent. Check your connection and try again.",
    template: {
      title: "Planned maintenance",
      message: "Our servers will be under maintenance on the night of {date}, [time window]. The app may be unavailable during this time. Thank you for your patience.",
    },
  },
  notifications: {
    title: "Notifications",
  ...
  team: {
    ...
    changeRoleLabel: "Change the member's role",
    roleUpdated: "The member's role was updated.",
    roleUpdateError: "The role could not be updated. Please try again.",
  ...
  profile: {
    ...
    platformAnnouncement: "Send Announcement",
  ...
  companies: {
    logo: {
      ...
      removeConfirm: "The office logo will be removed and initials shown instead.",
      removed: "Office logo removed.",
    },
    title: "Companies",
  ...
  progress: {
    ...
    extrasHint: "Amounts outside the work items — variations, escalation, advances, penalties. They are added to the contract total.",
    ...
    payOutgoing: "Pay Subcontractor",
    deletePaymentTitle: "Delete payment",
    deletePaymentMessage: "{label} and its finance entry will be deleted. Are you sure?",
    paymentNumberWithItemCost: "{item} · Subcontractor Payment No. {number}",
    ...
    remaining: "Left to Bill",
    costPaid: "Paid to Subcontractors",
    billedMeta: "Billed {billed} · Left {remaining}",
    costMeta: "Subcontractor: paid {paid} · left {remaining}",
    noValueHint: "Enter the item's value under Edit before billing it.",
    pay: "Pay",
    payAmountLabel: "Billing amount (₺)",
    payAmountCostLabel: "Subcontractor payment (₺)",
    payRemainingHint: "{amount} left. Change the amount for a partial bill.",
    payInvalid: "Enter a valid amount.",
    payTooMuch: "The amount can't exceed what's left of the item ({amount}). Add anything beyond it as a variation under Other Receivables and Payables.",
    paymentFailed: "The progress payment couldn't be saved. Please try again.",
  ...
  support: {
    ...
    ticketsDesc: "Send us your suggestions, requests and issues",
